...
window.onload = function() {
    ...
    var firebaseConfig = {
      apiKey: "AIzaSyCvpibbn26vP7MJk84EOxTQ4jOrxwWcKzY",
      authDomain: "hiba-chat-ef273.firebaseapp.com",
      projectId: "hiba-chat-ef273",
      storageBucket: "hiba-chat-ef273.appspot.com",
      messagingSenderId: "975594495726",
      appId: "1:975594495726:web:7351dc1bf11580d45b5dff",
    };
    ...
    class B_Kurs_Girls {
      ...
      create_title() {
        ...
        title.textContent = 'B-Kurs Girls 🚀';
      ...
      create_join_form() {
        ...
        join_input.onkeyup = function (event) {
          ...
          // If Enter key is pressed, trigger the join button click
          if (event.key === 'Enter' && join_input.value.length > 0) {
            join_button.click();
          }
        };
      ...
      create_chat() {
        ...
        var parent = this;
        // GET THAT HIBACHAT HEADER OUTTA HERE
